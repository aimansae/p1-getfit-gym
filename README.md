 ...
 * Google Fonts [Anton](https://fonts.google.com/specimen/Anton) and [Heebo](https://fonts.google.com/specimen/Heebo) are used. Fonts are directly imported at the top of the CSS stylesheet with Sans-srif as a Fallback Font.
 ## Images
...
### About us 
* Right below the Image, you can find the "About Us" div that contains a brief description about the gym, locations and the main services.
...
* The user will be able to choose between 2 offers: Standard and Premium and by clicking on the Join button he is redirected to the contact form.
...
*Furthermore the forms is styled to enable the user to immediately be able to select their preferred deal thanks to "Select" element.
...
* There were several issues regarding the background images, footer and flexbox property: <br>
* Navigation links were not aligned to the header logo.
...
Code Institute Slack community was consulted to check if fellow students are having the same issues. The given solutions/ advices were applied to Get Fit Gym site. <br>

* Code institute Tutors were consulted especially for responsive styles and background images.
...
* Color Palette is generated through [Colors](https://coolors.co/)
